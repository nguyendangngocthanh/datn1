...
<head>
    ...
    <title>{{ $title }}</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="https://i.ibb.co/jMNKGTh/logo.png">
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="https://i.ibb.co/jMNKGTh/logo.png" alt="homepage" class="dark-logo" style="max-height: 40px;" />
                            <!-- Light Logo icon -->
                            <img src="https://i.ibb.co/jMNKGTh/logo.png" alt="homepage" class="light-logo" style="max-height: 40px;" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="https://i.ibb.co/jMNKGTh/logo.png" alt="user" class="rounded-circle" width="31">
                            </a>
