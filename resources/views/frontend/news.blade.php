                ...
                @foreach ($newsList as $item)
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="blog__item">
                            <div class="blog__item__pic set-bg" data-setbg="{{ $item->thumbnail }}"
                                style="background-image: url(&quot;{{ $item->thumbnail }};);"></div>
                            <div class="blog__item__text">
                                <span><img src="../themes/frontend1/img/icon/calendar.png"
                                        alt="">{{ getTimeFormat($item->updated_at) }}</span>
                                <h5>
                                    {{ $item->title }}
                                </h5>
                                <a href="{{ route('frontend.post', ['id'=>$item->id, 'href_param'=>$item->href_param]) }}">Đọc
                                    chi tiết</a>
                            </div>
                        </div>
                    </div>
