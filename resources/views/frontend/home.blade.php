...
@section('slider')
  ...
  <section class="hero">
    <div class="hero__slider owl-carousel">
        <div class="hero__items set-bg" data-setbg="../themes/frontend1/img/hero/hero-1.jpg" style="background-image: url(&quot;../themes/frontend1/img/hero/hero-1.jpg&quot;);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
                            ...
                            <a href="{{ route('frontend.products') }}" class="primary-btn">Shop now <span class="arrow_right"></span></a>
        ...
        <<div class="hero__items set-bg" data-setbg="../themes/frontend1/img/hero/hero-2.jpg" style="background-image: url(&quot;../themes/frontend1/img/hero/hero-2.jpg&quot;);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-7 col-md-8">
                        <div class="hero__text">
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="../themes/frontend1/img/banner/banner-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="../themes/frontend1/img/banner/banner-2.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Accessories</h2>
                            <a href="#">Shop now</a>
                ...
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="../themes/frontend1/img/banner/banner-3.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6>{{ $item->title }}</h6>
                            <a href="{{ route('frontend.detail',['id'=>$item->id,'href_param'=>$item->slug]) }}" class="add-cart">+ Thêm giỏ hàng</a>                            <div class="rating">
